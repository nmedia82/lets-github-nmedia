...
class NM_OnePageWoo_Admin extends NM_OnePageWoo{
	...
	*/
	...
	function save_settings(){
		...
		_e('All options are updated', 'nm-opw');
		die(0);
	}
	...
	function render_settings_input($data) {
		...
		switch($type) {
			...
			case 'media' :
				...
				echo ' <a href="javascsript:;" class="remove-media"><i class="fa fa-pencil"></i>'.__('Remove', 'nm-opw').'</a>';
